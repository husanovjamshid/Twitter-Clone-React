        ...
        <div className="row">
          ...
          <div className="col-md-7">
            <form className="tweets__form-area">
              <textarea className="tweets__area" placeholder="What’s happening"></textarea>

              <div className="d-flex gap-2">
                <img className="stikers" width="30px" src={image} alt="" />
                <img className="stikers img-fluid" width="30px" src={gif} alt="" />
                <img className="stikers img-fluid" width="30px" src={stat} alt="" />
                <img className="stikers img-fluid" width="30px" src={emoji} alt="" />
                <img className="stikers img-fluid" width="30px" src={date} alt="" />
              </div>
            </form>
          </div>
          <div className="col-md-4 position-relative">
            <a className="addTweet__link">Tweet</a>
          </div>
        </div>
      </div>
      <hr />
